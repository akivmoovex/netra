...
module.exports = function adminRoutes({ db }) {
  ...
  router.get("/companies/new", (_req, res) => {
    ...
    return res.render("admin/company_form", { company: null, categories, baseDomain: process.env.BASE_DOMAIN || "netra-zambia.com" });
  });
  ...
  router.get("/companies/:id/edit", (req, res) => {
    ...
    const categories = getCategoriesForSelect(db);
    return res.render("admin/company_form", { company, categories, baseDomain: process.env.BASE_DOMAIN || "netra-zambia.com" });
  });
